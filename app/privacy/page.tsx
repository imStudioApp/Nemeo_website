...
/* The source policy is legal copy; preserve its punctuation verbatim. */
/* eslint-disable react/no-unescaped-entities */

export const metadata: Metadata = {
  title: "Privacy Policy — Nemeo",
  description: "Privacy Policy for Nemeo.",
};
    ...
    sections={[
      {
        ...
        content: <>
          ...
          <ul>
            ...
            <li><strong>Application</strong> refers to Nemeo, the software program provided by the Company.</li>
            <li><strong>Company</strong> (referred to as either “the Company”, “We”, “Us” or “Our” in this Privacy Policy) refers to Nemeo.</li>
      ...
      },
      {
        ...
        content: <>
          ...
          <h4>Personal Data</h4>
          <h4>Usage Data</h4>
          <p>Usage Data is collected automatically when using Our Service.</p>
          ...
          <p>We use tracking technologies (such as cookies) to track the activity and to improve the Service. The technologies We use may include:</p>
        ...
        content: <>
          ...
          <ul>
            ...
            <li><strong>Usage Data</strong>
              <ul>
                <li><strong>Application usage statistics:</strong> up to 24 months to understand feature adoption and service improvements.</li>
      ...
      },
      {
        ...
        content: <p>The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage, is 100% secure. While We strive to use commercially reasonable means to protect Your Personal Data, We cannot guarantee its absolute security.</p>,
      },
      {
        title: "Children's and Minors' Privacy",
        content: <p>The Service is not directed to, and We do not knowingly collect Personal Information from, anyone under the age of 16.<br /><br />If You are a parent or guardian and You believe your child has provided Us with Personal Information, please contact Us. If We become aware that We have collected Personal Information from anyone under the age of 16, We will take steps to remove that information from Our servers as soon as reasonably possible.<br /><br />Some countries and states set a higher age at which an individual can consent to the processing of their own Personal Information. Where We rely on consent as a legal basis and the law applicable to a User sets an age higher than 16, We may require the consent of that User's parent or guardian before We collect and use their Personal Information.</p>,
      },
      {
        title: "Links to Other Websites",
        content: <p>Our Service may contain links to other websites that are not operated by Us. If You click on a third-party link, You will be directed to that third party's site. We strongly advise You to review the Privacy Policy of every site You visit.<br /><br />We have no control over and assume no responsibility for the content, privacy policies or practices of any third-party sites or services.</p>,
      },
      {
      ...
      },
      {
        ...
        content: <>
          ...
          <p><a href="mailto:im.studio.app@gmail.com">im.studio.app@gmail.com</a></p>
        </>,
      },
    ]}
  />;
